...
def enviar_usuario(app,title, recipient, accion, usuario,contra):
    enviar = "veterinariabuenproductor@gmail.com"
    app.config.update(
    MAIL_SERVER = 'smtp.gmail.com',
    MAIL_PORT = 465,
...
def enviar_correo_orden(app,title, recipient, accion,orden ):
    enviar = "veterinariabuenproductor@gmail.com"
    app.config.update(
    MAIL_SERVER = 'smtp.gmail.com',
    MAIL_PORT = 465,
    ...
    msg.html = render_template('sistema/correo.html',accion = accion,orden = orden)
    mail.send(msg)